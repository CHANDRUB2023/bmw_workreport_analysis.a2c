        ...
        <div className="lg:col-span-6 bg-slate-50 border border-slate-200 rounded-xl p-4 space-y-3 text-xs">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-slate-300 rounded-lg font-black text-sm text-blue-900 bg-white shadow-2xs focus:ring-2 focus:ring-blue-500 focus:outline-hidden"
            />
          </div>
        ...
        <div className="lg:col-span-6 flex flex-col justify-between space-y-3">
          <div className="grid grid-cols-3 gap-2">
            <div className="bg-slate-100 border border-slate-200 rounded-lg p-3 text-center">
              ...
              <span className="text-2xl font-black text-slate-800">{currentMembers}</span>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-center">
              ...
              <span className="text-2xl font-black text-blue-900">{requiredMembers}</span>
            ...
            <div className={`border rounded-lg p-3 text-center ${
              ...
              <span className="text-2xl font-black">{additionalNeeded}</span>
              <span className="text-[10px] block font-medium">Members</span>
            </div>
          </div>

          {/* Clean Primary Result Highlight */}
          <div className="bg-gradient-to-r from-blue-900 to-indigo-900 text-white rounded-xl p-4 flex items-center justify-between shadow-xs">
            <div>
              <span className="text-[10px] font-bold text-blue-200 uppercase tracking-widest block">Target Workload</span>
              <div className="text-xl font-black">{remainingWorkPincodes} REMAINING WORK PINCODES</div>
            </div>
            <div className="text-right">
              <span className="text-xs font-bold text-emerald-400">{requiredMembers} Team Members Required</span>
            </div>
          </div>

          {/* Hidden/Expandable Calculation Formula */}
          <details className="group bg-slate-50 border border-slate-200 rounded-xl p-3 text-xs">
