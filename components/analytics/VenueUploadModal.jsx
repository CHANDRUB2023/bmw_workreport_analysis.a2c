  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-2xl w-full p-6 space-y-5 max-h-[90vh] flex flex-col animate-modal-pop">
        ...
        <div className="flex-1 overflow-y-auto pr-1">
          ...
          {step === 'SELECT' && (
            <div className="space-y-4">
              <div className="border-2 border-dashed border-slate-300 hover:border-blue-500 rounded-2xl p-6 text-center transition-all duration-300 bg-slate-50/50 hover:bg-blue-50/60 hover:scale-[1.008] flex flex-col items-center justify-center space-y-3 cursor-pointer relative group">
                <input
                  type="file"
                  accept=".xlsx, .xls"
                ...
                />
                <div className="p-3 bg-blue-50 text-blue-600 rounded-full group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300 shadow-2xs">
                  <UploadCloud className="w-8 h-8" />
                </div>
                <div>
                  <span className="text-sm font-extrabold text-slate-800 block group-hover:text-blue-900 transition-colors">
                ...
                {selectedFile && (
                  <div className="mt-2 inline-flex items-center gap-2 px-3.5 py-1.5 bg-blue-100 text-blue-900 border border-blue-200 rounded-xl text-xs font-bold shadow-2xs animate-badge-pop">
        ...
        {/* Footer Actions */}
        {step === 'SELECT' && (
          <div className="border-t border-slate-200/90 pt-3 flex items-center justify-end gap-2">
            <button
              onClick={onClose}
              className="px-4 py-2 text-xs font-bold text-slate-600 hover:text-slate-900 bg-slate-100/90 hover:bg-slate-200/90 active:scale-95 rounded-xl transition-all cursor-pointer shadow-2xs"
            >
              Cancel
            </button>
            <button
              ...
              className="px-5 py-2 text-xs font-extrabold text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 active:scale-95 disabled:opacity-50 rounded-xl shadow-md shadow-blue-600/20 transition-all flex items-center gap-1.5 cursor-pointer"
            >
        ...
        {step === 'PREVIEW' && (
          <div className="border-t border-slate-200/90 pt-3 flex items-center justify-between">
            <button
              onClick={handleReset}
              className="px-4 py-2 text-xs font-bold text-slate-600 hover:text-slate-900 bg-slate-100/90 hover:bg-slate-200/90 active:scale-95 rounded-xl transition-all cursor-pointer shadow-2xs"
            >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-5 py-2 text-xs font-extrabold text-white bg-emerald-600 hover:bg-emerald-700 active:scale-95 disabled:opacity-50 rounded-xl shadow-md shadow-emerald-600/20 transition-all flex items-center gap-1.5 cursor-pointer"
              >
